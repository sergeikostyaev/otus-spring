...
public class ShellController {
    ...
    @ShellMethod(key = {"getBooksByAuthorAndGenre", "gbag"})
    public void getBooksByAuthorAndGenre(long authorId, long genreId) {
        List<BookDto> books = libraryService.getBooksByAuthorAndGenre(authorId, genreId);
